          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Configure VibeFlow AI and integrations</p>
              </div>
            </div>
            <button
              onClick={handleSave}
              disabled={!anthropicKey && !openaiKey && !githubToken && !saved}
              className="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all font-medium shadow-sm hover:shadow-md"
            >
              {saved ? (
          ...
          <div className="p-6 space-y-4">
            ...
            <div
              ...
              className={`group relative p-6 border-2 rounded-xl cursor-pointer transition-all ${
                provider === 'claude'
                  ? 'border-gradient-to-r from-orange-400 to-pink-500 bg-gradient-to-br from-orange-50 to-pink-50 shadow-md'
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="text-lg font-bold text-gray-900">Anthropic Claude</h3>
            ...
            <div
              ...
              className={`group relative p-6 border-2 rounded-xl cursor-pointer transition-all ${
                provider === 'openai'
                  ? 'border-gradient-to-r from-emerald-400 to-cyan-500 bg-gradient-to-br from-emerald-50 to-cyan-50 shadow-md'
                  : 'border-gray-200 hover:border-gray-300 hover:shadow-sm'
              }`}
            >
              <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all font-mono text-sm"
                />
